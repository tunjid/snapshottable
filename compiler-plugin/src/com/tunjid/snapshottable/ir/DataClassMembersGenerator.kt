...
abstract class DataClassMembersGenerator(
            ...
            for (property in properties) {
                ...
                +irIfThenReturnFalse(
                    IrCallImplWithShape(
                        ...
                        arguments[0] =
                            this@MemberFunctionBuilder.irEquals(arg1, arg2, origin = IrStatementOrigin.EXCLEQ)
                    }
                )
            }
            +irReturnTrue()
    ...
    protected open fun getHashCodeOf(
    ...
    protected fun IrBuilderWithScope.getHashCodeOf(
        hashCodeFunctionInfo: HashCodeFunctionInfo,
        irValue: IrExpression
    ): IrExpression {
        val hashCodeFunctionSymbol = hashCodeFunctionInfo.symbol
        val hasDispatchReceiver =
            hashCodeFunctionInfo.hasDispatchReceiver ?: hashCodeFunctionSymbol.hasDispatchReceiver()
